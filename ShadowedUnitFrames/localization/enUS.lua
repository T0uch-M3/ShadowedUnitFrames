...
L["Current health (Druid/Absolute)"] = "Current power (Druid/Absolute)"
...
L["Elite icon for npcs or mobs."] = "Elite icon for npcs or mobs."
...
L["Hides the cooldown ring for auras."] = "Hides the cooldown ring for auras."
...
L["Short classifications, R for Rare, RE for Rare Elite, R for Elite, BOSS for boss, nothing is shown if they aren't any of those."] = "Short classifications, R for Rare, RE for Rare Elite, E for Elite, BOSS for boss, nothing is shown if they aren't any of those."
...
L["Timers for auras"] = "Timers for auras"
L["Top"] = "Top"
