...
SML:Register(SML.MediaType.FONT, "Aldrich", "Interface\\AddOns\\ShadowedUnitFrames\\media\\fonts\\Aldrich.ttf")
SML:Register(SML.MediaType.FONT, "Bangers", "Interface\\AddOns\\ShadowedUnitFrames\\media\\fonts\\Bangers.ttf")
SML:Register(SML.MediaType.FONT, "Myriad Condensed Web", "Interface\\AddOns\\ShadowedUnitFrames\\media\\fonts\\Celestia.ttf")
SML:Register(SML.MediaType.FONT, "Celestia", "Interface\\AddOns\\ShadowedUnitFrames\\media\\fonts\\DorisPP.ttf")
SML:Register(SML.MediaType.FONT, "Enigmatic", "Interface\\AddOns\\ShadowedUnitFrames\\media\\fonts\\Enigmatic.ttf")
SML:Register(SML.MediaType.FONT, "FasterOne", "Interface\\AddOns\\ShadowedUnitFrames\\media\\fonts\\FasterOne.ttf")
SML:Register(SML.MediaType.FONT, "Fitzgerald", "Interface\\AddOns\\ShadowedUnitFrames\\media\\fonts\\Fitzgerald.ttf")
SML:Register(SML.MediaType.FONT, "HDZB_35", "Interface\\AddOns\\ShadowedUnitFrames\\media\\fonts\\HDZB_35.ttf")
SML:Register(SML.MediaType.FONT, "Iceland", "Interface\\AddOns\\ShadowedUnitFrames\\media\\fonts\\Iceland.ttf")
SML:Register(SML.MediaType.FONT, "Iconsolata", "Interface\\AddOns\\ShadowedUnitFrames\\media\\fonts\\Iconsolata.ttf")
SML:Register(SML.MediaType.FONT, "Luna", "Interface\\AddOns\\ShadowedUnitFrames\\media\\fonts\\Luna.ttf")
SML:Register(SML.MediaType.FONT, "MetalLord", "Interface\\AddOns\\ShadowedUnitFrames\\media\\fonts\\MetalLord.ttf")
SML:Register(SML.MediaType.FONT, "Optimus", "Interface\\AddOns\\ShadowedUnitFrames\\media\\fonts\\Optimus.ttf")
SML:Register(SML.MediaType.FONT, "VeraSerif", "Interface\\AddOns\\ShadowedUnitFrames\\media\\fonts\\VeraSerif.ttf")
SML:Register(SML.MediaType.FONT, "Gentium", "Interface\\AddOns\\ShadowedUnitFrames\\media\\fonts\\Gentium.ttf")
SML:Register(SML.MediaType.FONT, "TradeWinds", "Interface\\AddOns\\ShadowedUnitFrames\\media\\fonts\\TradeWinds.ttf")
SML:Register(SML.MediaType.FONT, "Yellowjacket", "Interface\\AddOns\\ShadowedUnitFrames\\media\\fonts\\Yellowjacket.ttf")
...
SML:Register(SML.MediaType.STATUSBAR, "Armory", "Interface\\AddOns\\ShadowedUnitFrames\\media\\textures\\Armory")
SML:Register(SML.MediaType.STATUSBAR, "Cilo", "Interface\\AddOns\\ShadowedUnitFrames\\media\\textures\\Cilo")
SML:Register(SML.MediaType.STATUSBAR, "Diagonal", "Interface\\AddOns\\ShadowedUnitFrames\\media\\textures\\Diagonal")
SML:Register(SML.MediaType.STATUSBAR, "Fifths", "Interface\\AddOns\\ShadowedUnitFrames\\media\\textures\\Fifths")
SML:Register(SML.MediaType.STATUSBAR, "Flat", "Interface\\AddOns\\ShadowedUnitFrames\\media\\textures\\Flat")
SML:Register(SML.MediaType.STATUSBAR, "Fourths", "Interface\\AddOns\\ShadowedUnitFrames\\media\\textures\\Fourths")
SML:Register(SML.MediaType.STATUSBAR, "Glamour", "Interface\\AddOns\\ShadowedUnitFrames\\media\\textures\\Glamour")
SML:Register(SML.MediaType.STATUSBAR, "Glamour2", "Interface\\AddOns\\ShadowedUnitFrames\\media\\textures\\Glamour2")
SML:Register(SML.MediaType.STATUSBAR, "Glamour3", "Interface\\AddOns\\ShadowedUnitFrames\\media\\textures\\Glamour3")
SML:Register(SML.MediaType.STATUSBAR, "Glamour4", "Interface\\AddOns\\ShadowedUnitFrames\\media\\textures\\Glamour4")
SML:Register(SML.MediaType.STATUSBAR, "Luna", "Interface\\AddOns\\ShadowedUnitFrames\\media\\textures\\Luna")
SML:Register(SML.MediaType.STATUSBAR, "Lyfe", "Interface\\AddOns\\ShadowedUnitFrames\\media\\textures\\Lyfe")
SML:Register(SML.MediaType.STATUSBAR, "Wisps", "Interface\\AddOns\\ShadowedUnitFrames\\media\\textures\\Wisps")
SML:Register(SML.MediaType.STATUSBAR, "Ruben", "Interface\\AddOns\\ShadowedUnitFrames\\media\\textures\\Ruben")
SML:Register(SML.MediaType.STATUSBAR, "Skewed", "Interface\\AddOns\\ShadowedUnitFrames\\media\\textures\\Skewed")
